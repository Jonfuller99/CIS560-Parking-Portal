...
window.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('tr-start-date').value = start;
    document.getElementById('tr-end-date').value = end;
    document.getElementById('cpt-start-date').value = start;
    document.getElementById('cpt-end-date').value = end;
    document.getElementById('ptd-start-date').value = start;
    document.getElementById('ptd-end-date').value = end;
